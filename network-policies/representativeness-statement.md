...
CSIDNet strives for representation across multiple, intersecting axes of diversity, including but not limited to: geography and time zones; languages and cultures; race and ethnicity; gender identities and expressions; academic disciplines and professional functions; career stages from early-career researchers to senior practitioners; institutional contexts from grassroots organizations to academic institutions; and the spectrum from tool developers to end users. Representativeness matters because it ensures decisions are informed by those most affected while drawing on a wide range of expertise. This leads to more scientifically rigorous and socially relevant research and tools, strengthening our collective ability to address climate-sensitive infectious diseases.

By approaching representativeness as a deliberate and ongoing practice, rather than a one-time goal, we aim to move beyond extractive models of global science and foster authentic collaboration grounded in mutuality, care, and the principle that those most affected by climate-sensitive infectious diseases must be centered in CSIDNet’s governance and activities.
